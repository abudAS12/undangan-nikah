                              ...
                              for (
                                ...
                                if (!p()(c, e)) {
                                  ...
                                  for (
                                    ...
                                    s["@type"] = f.substr(
                                      f.indexOf("schema.org/index.html") +
                                        "schema.org/".length
                                    );
                                    for (
                                      f = o()(
                          ...
                          c = (function (a, b, c) {
                            ...
                            switch (b) {
                              case ja:
                                b = n()(
                                  q()(
                                    a.pathname.split("https://undgn.id/"),
                                    function (a) {
                                      return a.trim();
                                    }
                                  ),
                  ...
                  case Kb.PAGE:
                    return (function (a, b) {
                      switch (a) {
                        ...
                        case Z.DOMAIN:
                          return new URL(b.html).hostname;
                        case Z.PAGE_TITLE:
              ...
              if (a.trustedTypes && a.trustedTypes.createPolicy) {
                ...
                return b.createPolicy("facebook.com/signals/iwl", {
                  createScriptURL: function (a) {
                    var b = new URL(a.html);
                    b =
                      b.hostname.endsWith(".facebook.com") &&
                      b.pathname == "../../../../signals/iwl.html";
